...
class ActivityPaintBottomBar
{
	...
	void postInitBottomBar()
	{
		...
		activity.addOnToolSelectListener(new ToolsAdapter.OnToolSelectListener() {
			@Override
	...
	{
		activity.registerActivityResultListener(REQUEST_PICK_COLOR, new ActivityResultListener()
		{
			@Override
			public void onActivityResult(int resultCode, Intent data)
			{
				ActivityPaintBottomBar.this.onActivityResult(data);
			}
		});
